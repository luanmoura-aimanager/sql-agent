...
- **Pendente — Sessão D-4 (opcional):** endpoint `/admin/cost?token_hash=X&since=Y` ou CLI `python -m scripts.cost_report`. Vê o valor do schema com queries reais.
- **Próximo bloco (depois de D-4):** Deployment — Docker, CI/CD, secrets. Encerra Cap 3 governança.
